...
-(void)setupPageTwo{
    ...
    [self performSelector:@selector(unhideProgress) withObject:nil afterDelay:2.0];
...
-(void)setupPageThree{
    ...
    if (self.sellerMode == YES) {
        ...
        self.explainLabel.text = @"After you've sent your offer, buyers can tap on the offer message, checkout & pay with PayPal - Easy!";
