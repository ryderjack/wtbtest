...
#define kPPRiskComponentVersion                @"3.6.0"
...
/*
 * Generate pairing id method with additionalParams, this will override the init time params.
 * For eg if fraudnet is enabled at init time, it can be turned off during the generate pairingid call
 */
- (NSString*)generatePairingId:(NSString*)pairingId withAdditionalData:(NSDictionary*)additionalData
          withAdditionalParams:(NSDictionary *)additionalParams;
